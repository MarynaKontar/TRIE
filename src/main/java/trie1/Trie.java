...
public class Trie{
    ...
    void storeWords(TrieContainer start, String word){
   ...
   boolean isWordPresent(TrieContainer start, String word){
    ...
    void printWordStrings(TrieContainer start, String toPrint) {
            if(start==null){
                return;
            }
            if(start.isEnd){
